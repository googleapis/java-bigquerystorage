...
public interface AppendRowsResponseOrBuilder extends
   ...
   * <code>.google.cloud.bigquery.storage.v1.AppendRowsResponse.AppendResult append_result = 1;</code>
   */
  com.google.cloud.bigquery.storage.v1.AppendRowsResponse.AppendResultOrBuilder getAppendResultOrBuilder();
   ...
   */
  java.util.List<com.google.cloud.bigquery.storage.v1.RowError> 
      getRowErrorsList();
  /**
   * <pre>
   * If a request failed due to corrupted rows, no rows in the batch will be
