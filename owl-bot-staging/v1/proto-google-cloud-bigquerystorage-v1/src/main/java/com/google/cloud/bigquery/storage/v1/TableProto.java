...
public final class TableProto {
  ...
  static {
    ...
    internal_static_google_cloud_bigquery_storage_v1_TableSchema_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_bigquery_storage_v1_TableSchema_descriptor,
        new java.lang.String[] { "Fields", });
    internal_static_google_cloud_bigquery_storage_v1_TableFieldSchema_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_google_cloud_bigquery_storage_v1_TableFieldSchema_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_bigquery_storage_v1_TableFieldSchema_descriptor,
        new java.lang.String[] { "Name", "Type", "Mode", "Fields", "Description", "MaxLength", "Precision", "Scale", "DefaultValueExpression", "RangeElementType", });
    internal_static_google_cloud_bigquery_storage_v1_TableFieldSchema_FieldElementType_descriptor =
      internal_static_google_cloud_bigquery_storage_v1_TableFieldSchema_descriptor.getNestedTypes().get(0);
    internal_static_google_cloud_bigquery_storage_v1_TableFieldSchema_FieldElementType_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_bigquery_storage_v1_TableFieldSchema_FieldElementType_descriptor,
