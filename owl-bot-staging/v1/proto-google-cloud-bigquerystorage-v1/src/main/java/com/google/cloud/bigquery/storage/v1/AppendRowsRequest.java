...
com.google.cloud.bigquery.storage.v1.AppendRowsRequest.MissingValueInterpretation defaultValue) {
   ...
   * </pre>
   *
   * <code>.google.cloud.bigquery.storage.v1.AppendRowsRequest.MissingValueInterpretation default_missing_value_interpretation = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
   * @return The enum numeric value on the wire for defaultMissingValueInterpretation.
   */
  @java.lang.Override public int getDefaultMissingValueInterpretationValue() {
   ...
   */
  @java.lang.Override public com.google.cloud.bigquery.storage.v1.AppendRowsRequest.MissingValueInterpretation getDefaultMissingValueInterpretation() {
    com.google.cloud.bigquery.storage.v1.AppendRowsRequest.MissingValueInterpretation result = com.google.cloud.bigquery.storage.v1.AppendRowsRequest.MissingValueInterpretation.forNumber(defaultMissingValueInterpretation_);
    return result == null ? com.google.cloud.bigquery.storage.v1.AppendRowsRequest.MissingValueInterpretation.UNRECOGNIZED : result;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    com.google.protobuf.GeneratedMessageV3
      .serializeStringMapTo(
        ...
        MissingValueInterpretationsDefaultEntryHolder.defaultEntry,
        7);
    if (defaultMissingValueInterpretation_ != com.google.cloud.bigquery.storage.v1.AppendRowsRequest.MissingValueInterpretation.MISSING_VALUE_INTERPRETATION_UNSPECIFIED.getNumber()) {
  ...
  public int getSerializedSize() {
    ...
    if (defaultMissingValueInterpretation_ != com.google.cloud.bigquery.storage.v1.AppendRowsRequest.MissingValueInterpretation.MISSING_VALUE_INTERPRETATION_UNSPECIFIED.getNumber()) {
      size += com.google.protobuf.CodedOutputStream
        .computeEnumSize(8, defaultMissingValueInterpretation_);
    }
    size += getUnknownFields().getSerializedSize();
    memoizedSize = size;
    return size;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (defaultMissingValueInterpretation_ != other.defaultMissingValueInterpretation_) return false;
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(com.google.cloud.bigquery.storage.v1.AppendRowsRequest other) {
      ...
      if (other.defaultMissingValueInterpretation_ != 0) {
        setDefaultMissingValueInterpretationValue(other.getDefaultMissingValueInterpretationValue());
      }
...
com.google.cloud.bigquery.storage.v1.AppendRowsRequest.MissingValueInterpretation defaultValue) {
     ...
     */
    @java.lang.Override
    public com.google.cloud.bigquery.storage.v1.AppendRowsRequest.MissingValueInterpretation getDefaultMissingValueInterpretation() {
      com.google.cloud.bigquery.storage.v1.AppendRowsRequest.MissingValueInterpretation result = com.google.cloud.bigquery.storage.v1.AppendRowsRequest.MissingValueInterpretation.forNumber(defaultMissingValueInterpretation_);
      return result == null ? com.google.cloud.bigquery.storage.v1.AppendRowsRequest.MissingValueInterpretation.UNRECOGNIZED : result;
    }
    /**
     ...
     * @return This builder for chaining.
     */
    public Builder setDefaultMissingValueInterpretation(com.google.cloud.bigquery.storage.v1.AppendRowsRequest.MissingValueInterpretation value) {
      if (value == null) {
        throw new NullPointerException();
      }
      bitField0_ |= 0x00000020;
