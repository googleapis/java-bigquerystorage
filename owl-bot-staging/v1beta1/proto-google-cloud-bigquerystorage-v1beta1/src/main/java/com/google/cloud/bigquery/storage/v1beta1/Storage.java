...
public final class Storage {
  ...
  private static final long serialVersionUID = 0L;
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 50: {
              com.google.cloud.bigquery.storage.v1beta1.ArrowProto.ArrowSchema.Builder subBuilder = null;
              if (schemaCase_ == 6) {
                subBuilder = ((com.google.cloud.bigquery.storage.v1beta1.ArrowProto.ArrowSchema) schema_).toBuilder();
              }
              schema_ =
                  input.readMessage(com.google.cloud.bigquery.storage.v1beta1.ArrowProto.ArrowSchema.parser(), extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom((com.google.cloud.bigquery.storage.v1beta1.ArrowProto.ArrowSchema) schema_);
                schema_ = subBuilder.buildPartial();
              }
              schemaCase_ = 6;
              break;
    ...
    @java.lang.Override public com.google.cloud.bigquery.storage.v1beta1.Storage.ShardingStrategy getShardingStrategy() {
      ...
      com.google.cloud.bigquery.storage.v1beta1.Storage.ShardingStrategy result = com.google.cloud.bigquery.storage.v1beta1.Storage.ShardingStrategy.valueOf(shardingStrategy_);
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34: {
              com.google.cloud.bigquery.storage.v1beta1.Storage.Progress.Builder subBuilder = null;
              if (progress_ != null) {
                subBuilder = progress_.toBuilder();
              }
              progress_ = input.readMessage(com.google.cloud.bigquery.storage.v1beta1.Storage.Progress.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    public static final class Builder extends
      ...
      public Builder mergeProgress(com.google.cloud.bigquery.storage.v1beta1.Storage.Progress value) {
        if (progressBuilder_ == null) {
          if (progress_ != null) {
            progress_ =
              com.google.cloud.bigquery.storage.v1beta1.Storage.Progress.newBuilder(progress_).mergeFrom(value).buildPartial();
          } else {
            progress_ = value;
          }
          onChanged();
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(
        ...
        try {
          ...
          parsedMessage = (com.google.cloud.bigquery.storage.v1beta1.Storage.Progress) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
