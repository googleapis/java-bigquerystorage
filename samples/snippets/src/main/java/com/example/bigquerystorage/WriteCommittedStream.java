...
public class WriteCommittedStream {
  ...
  public void append(JSONArray data, int offset)
    ...
    ApiFuture<AppendRowsResponse> future = streamWriter.append(data, /*offset=*/ offset - 1);
  ...
  class AppendCompleteCallback implements ApiFutureCallback<AppendRowsResponse> {
    private final WriteCommittedStream parent;

    AppendCompleteCallback(WriteCommittedStream parent) {
      this.parent = parent;
    }
