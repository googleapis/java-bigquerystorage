...
```Groovy
compile 'com.google.cloud:google-cloud-bigquerystorage:0.131.3-beta'
```
If you are using SBT, add this to your dependencies
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-bigquerystorage" % "0.131.3-beta"
```
