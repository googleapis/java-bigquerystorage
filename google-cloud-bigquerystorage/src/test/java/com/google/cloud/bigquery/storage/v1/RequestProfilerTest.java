...
public class RequestProfilerTest {
    ...
    public void testNormalCase() throws Exception {
        RequestProfiler.REQUEST_PROFILER_SINGLETON.startOperation(OperationName.TOTAL_REQUEST, "request_1");
        RequestProfiler.REQUEST_PROFILER_SINGLETON.startOperation(OperationName.JSON_TO_PROTO_CONVERSION, "request_1");
        RequestProfiler.REQUEST_PROFILER_SINGLETON.endOperation(OperationName.JSON_TO_PROTO_CONVERSION, "request_1");
        RequestProfiler.REQUEST_PROFILER_SINGLETON.startOperation(OperationName.BACKEND_LATENCY, "request_1");

        // Another request starts in the middle
        RequestProfiler.REQUEST_PROFILER_SINGLETON.startOperation(OperationName.TOTAL_REQUEST, "request_2");
        RequestProfiler.REQUEST_PROFILER_SINGLETON.startOperation(OperationName.JSON_TO_PROTO_CONVERSION, "request_2");
        RequestProfiler.REQUEST_PROFILER_SINGLETON.endOperation(OperationName.JSON_TO_PROTO_CONVERSION, "request_2");

        // Continue request 1
        RequestProfiler.REQUEST_PROFILER_SINGLETON.endOperation(OperationName.BACKEND_LATENCY, "request_1");

        // Continue request 2
        RequestProfiler.REQUEST_PROFILER_SINGLETON.startOperation(OperationName.BACKEND_LATENCY, "request_2");
        RequestProfiler.REQUEST_PROFILER_SINGLETON.endOperation(OperationName.BACKEND_LATENCY, "request_2");
        RequestProfiler.REQUEST_PROFILER_SINGLETON.endOperation(OperationName.TOTAL_REQUEST, "request_2");

        // Continue request 1
        RequestProfiler.REQUEST_PROFILER_SINGLETON.endOperation(OperationName.TOTAL_REQUEST, "request_1");
                    ...
                    threadPool.submit(
                            () -> {
                                try {
                                    ...
                                    RequestProfiler.REQUEST_PROFILER_SINGLETON.endOperation(
                                            OperationName.TOTAL_REQUEST, uuid);
                                    String unused = RequestProfiler.REQUEST_PROFILER_SINGLETON
                                            .flushAndGenerateReportText();
                                } catch (InterruptedException e) {
                                    throw new RuntimeException(e);
                                }
                            }));
