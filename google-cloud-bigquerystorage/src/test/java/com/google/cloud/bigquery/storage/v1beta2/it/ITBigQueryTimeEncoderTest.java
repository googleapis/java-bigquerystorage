...
public class ITBigQueryTimeEncoderTest {
  ...
  public void TestTimeEncoding()
    ...
    try (JsonStreamWriter jsonStreamWriter =
      ...
      row.put("test_time_micros", CivilTimeEncoder.encodePacked64TimeMicros(LocalTime.of(13, 14, 15, 16_000_000)));
      row.put("test_datetime_micros", CivilTimeEncoder.encodePacked64DatetimeMicros(LocalDateTime.of(1, 1, 1, 12, 0, 0, 0)));
      ...
      assertEquals("13:14:15.016000"
          , currentRow.get(3).getStringValue());
      assertEquals("0001-01-01T12:00:00"
          , currentRow.get(4).getStringValue());
    }
  }
}
