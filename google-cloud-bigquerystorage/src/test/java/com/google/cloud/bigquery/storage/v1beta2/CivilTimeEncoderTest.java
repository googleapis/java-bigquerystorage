...
public class CivilTimeEncoderTest {
  ...
  public void Packed64TimeMicrosTest() {
    ...
    // 0xD38F00010
    assertEquals(LocalTime.of(13, 14, 15, 16_000),
  ...
  public void Packed64DateTimeMicrosTest() {
    ...
    // 0b0000000000000000000000|00000000000001|0001|00001|00000|000000|000000
    // 0x4420000
    assertEquals(0x442000000000L, CivilTimeEncoder.encodePacked64DatetimeMicros(
        LocalDateTime.of(1, 1, 1, 0, 0, 0, 0)));
    // 0001/02/03 00:01:02
    // 0b0000000000000000000000|00000000000001|0010|00011|00000|000001|000010
    // 0x4860042
    assertEquals(0x486004200BB8L, CivilTimeEncoder.encodePacked64DatetimeMicros(
            LocalDateTime.of(1, 2, 3, 0, 1, 2, 3_000_000)));
    // 0001/01/01 12:00:00
    // 0b0000000000000000000000|00000000000001|0001|00001|01100|000000|000000
    // 0x442C000
    assertEquals(0x442C00000000L, CivilTimeEncoder.encodePacked64DatetimeMicros(
        LocalDateTime.of(1, 1, 1, 12, 0, 0, 0)));
    // 0001/01/01 13:14:15
    // 0b0000000000000000000000|00000000000001|0001|00001|01101|001110|001111
    // 0x442D38F
    assertEquals(0x442D38F03E80L, CivilTimeEncoder.encodePacked64DatetimeMicros(
            LocalDateTime.of(1, 1, 1, 13, 14, 15, 16_000_000)));
    // 9999/12/31 23:59:59
    // 0b0000000000000000000000|10011100001111|1100|11111|10111|111011|111011
    // 0x9C3F3F7EFB
    assertEquals(0x9C3F3F7EFBF3E58L, CivilTimeEncoder.encodePacked64DatetimeMicros(
            LocalDateTime.of(9999, 12, 31, 23, 59, 59, 999_000_000)));

    // 0001/01/01 00:00:00
    // 0b0000000000000000000000|00000000000001|0001|00001|00000|000000|000000
    // 0x4420000
    assertEquals(LocalDateTime.of(1, 1, 1, 0, 0, 0, 0),
        CivilTimeEncoder.decodePacked64DatetimeMicros(0x442000000000L));
    // 0001/02/03 00:01:02
    // 0b0000000000000000000000|00000000000001|0010|00011|00000|000001|000010
    // 0x4860042
    assertEquals(LocalDateTime.of(1, 2, 3, 0, 1, 2, 3_000_000),
        CivilTimeEncoder.decodePacked64DatetimeMicros(0x486004200BB8L));
    // 0001/01/01 12:00:00
    // 0b0000000000000000000000|00000000000001|0001|00001|01100|000000|000000
    // 0x442C000
    assertEquals(LocalDateTime.of(1, 1, 1, 12, 0, 0, 0),
        CivilTimeEncoder.decodePacked64DatetimeMicros(0x442C00000000L));
    // 0001/01/01 13:14:15
    // 0b0000000000000000000000|00000000000001|0001|00001|01101|001110|001111
    // 0x442D38F
    assertEquals(LocalDateTime.of(1, 1, 1, 13, 14, 15, 16_000_000),
        CivilTimeEncoder.decodePacked64DatetimeMicros(0x442D38F03E80L));
    // 9999/12/31 23:59:59
    // 0b0000000000000000000000|10011100001111|1100|11111|10111|111011|111011
    // 0x9C3F3F7EFB
    assertEquals(LocalDateTime.of(9999, 12, 31, 23, 59, 59, 999_000_000),
