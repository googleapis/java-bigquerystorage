 ...
 *
 * <p>For example, to set the total timeout of batchCreateMetastorePartitions to 30 seconds:
 *
 * <pre>{@code
...
public class MetastorePartitionServiceSettings
  ...
  public static InstantiatingHttpJsonChannelProvider.Builder
    ...
    return MetastorePartitionServiceStubSettings.defaultHttpJsonTransportProviderBuilder();
  }
  ...
  public static class Builder
    ...
    private static Builder createHttpJsonDefault() {
      return new Builder(MetastorePartitionServiceStubSettings.newHttpJsonBuilder());
    }
