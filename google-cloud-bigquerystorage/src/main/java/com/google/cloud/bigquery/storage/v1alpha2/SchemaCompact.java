...
public class SchemaCompact {
  ...
  /**
   * Checks if the userSchema is compatible with the table's current schema for writing.
   *
   * @param client
   * @param tableName
   * @param userSchema
  ...
  public void check(String tableName, Descriptors.Descriptor userSchema) {
    com.google.cloud.bigquery.Table table = bigquery.getTable(getTableId(tableName));
