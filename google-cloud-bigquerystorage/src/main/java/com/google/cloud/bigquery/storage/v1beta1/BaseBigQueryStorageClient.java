...
public class BaseBigQueryStorageClient implements BackgroundResource {
   ...
   *
   * @param table_reference Required. Reference to the table to read.
   ...
   * @param requested_streams Initial number of streams. If unset or 0, we will provide a value of
   ...
   * @param requested_streams Required. Number of new streams requested. Must be positive. Number of
   ...
   *
   * @param original_stream Required. Stream to split.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
