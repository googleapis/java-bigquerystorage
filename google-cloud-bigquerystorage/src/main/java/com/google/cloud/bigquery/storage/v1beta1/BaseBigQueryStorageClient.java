 ...
 *    <tr>
 *      <td>CreateReadSession</td>
 *      <td><p>Creates a new read session. A read session divides the contents of a
 ...
 *  not require manual clean-up by the caller.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>createReadSession(TableReferenceProto.TableReference tableReference, ProjectName parent, int requestedStreams)
 *           <li>createReadSession(TableReferenceProto.TableReference tableReference, String parent, int requestedStreams)
 *           <li>createReadSession(Storage.CreateReadSessionRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>createReadSessionCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>ReadRows</td>
 *      <td><p>Reads rows from the table in the format prescribed by the read session.
 ...
 *  session, and may change as other streams continue to read data.</p></td>
 *      <td>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>readRowsCallable()
 ...
 *    </tr>
 *    <tr>
 *      <td>BatchCreateReadSessionStreams</td>
 *      <td><p>Creates additional streams for a ReadSession. This API can be used to
 *  dynamically adjust the parallelism of a batch processing task upwards by
 *  adding additional workers.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>batchCreateReadSessionStreams(Storage.ReadSession session, int requestedStreams)
 *           <li>batchCreateReadSessionStreams(Storage.BatchCreateReadSessionStreamsRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>batchCreateReadSessionStreamsCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>FinalizeStream</td>
 *      <td><p>Causes a single stream in a ReadSession to gracefully stop. This
 ...
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>finalizeStream(Storage.FinalizeStreamRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>finalizeStream(Storage.Stream stream)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>finalizeStreamCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>SplitReadStream</td>
 *      <td><p>Splits a given read stream into two Streams. These streams are referred to
 ...
 *  completion.
 *
 *  This method is guaranteed to be idempotent.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>splitReadStream(Storage.SplitReadStreamRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>splitReadStream(Storage.Stream originalStream)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>splitReadStreamCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    </tr>
