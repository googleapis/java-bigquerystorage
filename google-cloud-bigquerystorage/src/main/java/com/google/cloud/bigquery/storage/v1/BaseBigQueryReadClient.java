 ...
 *      <ul>
 *           <li>createReadSession(CreateReadSessionRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>createReadSession(ProjectName parent, ReadSession readSession, int maxStreamCount)
 *           <li>createReadSession(String parent, ReadSession readSession, int maxStreamCount)
 *      </ul>
 ...
 *    <tr>
 *      <td>ReadRows</td>
 *      <td><p>Reads rows from the stream in the format prescribed by the ReadSession.
 *  Each response contains one or more table rows, up to a maximum of 100 MiB
 *  per response; read requests which attempt to read individual rows larger
 *  than 100 MiB will fail.
 *
 *  Each request also returns a set of stream statistics reflecting the current
 *  state of the stream.</p></td>
 *      <td>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>readRowsCallable()
 ...
 *      <td><p>Splits a given `ReadStream` into two `ReadStream` objects. These
 ...
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>splitReadStream(SplitReadStreamRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
