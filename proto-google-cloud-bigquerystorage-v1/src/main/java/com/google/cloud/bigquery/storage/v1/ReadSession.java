...
public final class ReadSession extends com.google.protobuf.GeneratedMessage
    implements
   ...
   */
  public static final class TableModifiers extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private TableModifiers(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
   ...
   */
  public static final class TableReadOptions extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private TableReadOptions(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      for (int i = 0; i < selectedFields_.size(); i++) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, selectedFields_.getRaw(i));
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(rowRestriction_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 2, rowRestriction_);
      }
      if (outputFormatSerializationOptionsCase_ == 3) {
        output.writeMessage(
            3,
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(rowRestriction_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(2, rowRestriction_);
      }
      if (outputFormatSerializationOptionsCase_ == 3) {
        size +=
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      public Builder mergeFrom(
        ...
        if (other.hasResponseCompressionCodec()) {
          setResponseCompressionCodecValue(other.getResponseCompressionCodecValue());
        }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 34:
                {
                  input.readMessage(
                      internalGetAvroSerializationOptionsFieldBuilder().getBuilder(),
                      extensionRegistry);
      ...
      public com.google.cloud.bigquery.storage.v1.AvroSerializationOptions.Builder
        ...
        return internalGetAvroSerializationOptionsFieldBuilder().getBuilder();
      }
      ...
      private com.google.protobuf.SingleFieldBuilder<
              ...
              com.google.cloud.bigquery.storage.v1.AvroSerializationOptions.Builder,
              com.google.cloud.bigquery.storage.v1.AvroSerializationOptionsOrBuilder>
          internalGetAvroSerializationOptionsFieldBuilder() {
        if (avroSerializationOptionsBuilder_ == null) {
          if (!(outputFormatSerializationOptionsCase_ == 4)) {
            outputFormatSerializationOptions_ =
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(traceId_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 13, traceId_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(traceId_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(13, traceId_);
    }
    if (estimatedRowCount_ != 0L) {
