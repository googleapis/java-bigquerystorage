  ...
  static {
    java.lang.String[] descriptorData = {
      "\n?google/cloud/bigquery/storage/v1alpha/"
          ...
          + "nserted_count\030\003 \001(\0032\202\013\n\031MetastorePartiti"
          + "onService\022\235\002\n\036BatchCreateMetastorePartit"
          + "ions\022L.google.cloud.bigquery.storage.v1a"
          + "lpha.BatchCreateMetastorePartitionsReque"
          + "st\032M.google.cloud.bigquery.storage.v1alp"
          + "ha.BatchCreateMetastorePartitionsRespons"
          + "e\"^\202\323\344\223\002X\"S/v1alpha/{parent=projects/*/l"
          + "ocations/*/datasets/*/tables/*}/partitio"
          + "ns:batchCreate:\001*\022\346\001\n\036BatchDeleteMetasto"
          + "rePartitions\022L.google.cloud.bigquery.sto"
          + "rage.v1alpha.BatchDeleteMetastorePartiti"
          + "onsRequest\032\026.google.protobuf.Empty\"^\202\323\344\223"
          + "\002X\"S/v1alpha/{parent=projects/*/location"
          + "s/*/datasets/*/tables/*}/partitions:batc"
          + "hDelete:\001*\022\235\002\n\036BatchUpdateMetastoreParti"
          + "tions\022L.google.cloud.bigquery.storage.v1"
          + "alpha.BatchUpdateMetastorePartitionsRequ"
          + "est\032M.google.cloud.bigquery.storage.v1al"
          + "pha.BatchUpdateMetastorePartitionsRespon"
          + "se\"^\202\323\344\223\002X\"S/v1alpha/{parent=projects/*/"
          + "locations/*/datasets/*/tables/*}/partiti"
          + "ons:batchUpdate:\001*\022\207\002\n\027ListMetastorePart"
          + "itions\022E.google.cloud.bigquery.storage.v"
          + "1alpha.ListMetastorePartitionsRequest\032F."
          + "google.cloud.bigquery.storage.v1alpha.Li"
          + "stMetastorePartitionsResponse\"]\332A\006parent"
          + "\202\323\344\223\002N\022L/v1alpha/{parent=projects/*/loca"
          + "tions/*/datasets/*/tables/*}/partitions:"
          + "list\022\264\001\n\031StreamMetastorePartitions\022G.goo"
          + "gle.cloud.bigquery.storage.v1alpha.Strea"
          + "mMetastorePartitionsRequest\032H.google.clo"
          + "ud.bigquery.storage.v1alpha.StreamMetast"
          + "orePartitionsResponse\"\000(\0010\001\032{\312A\036bigquery"
          + "storage.googleapis.com\322AWhttps://www.goo"
          + "gleapis.com/auth/bigquery,https://www.go"
          + "ogleapis.com/auth/cloud-platformB\272\002\n)com"
          + ".google.cloud.bigquery.storage.v1alphaB\036"
          + "MetastorePartitionServiceProtoP\001ZCcloud."
          + "google.com/go/bigquery/storage/apiv1alph"
          + "a/storagepb;storagepb\252\002%Google.Cloud.Big"
          + "Query.Storage.V1Alpha\312\002%Google\\Cloud\\Big"
          + "Query\\Storage\\V1alpha\352AU\n\035bigquery.googl"
